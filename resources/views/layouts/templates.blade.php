...
<head>
    ...
    <link href="{{ asset('vendor/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('vendor/assets/css/soft-ui-dashboard.css?v=1.0.3') }}" rel="stylesheet" />
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="" target="_blank">
                <img src="{{ asset('vendor/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-flex justify-content-center">
                    <a href="" class="btn btn-danger" style="width: 90%">Keluar</a>
                </li>
            </ul>
        </div>
    </aside>
